package com.hjx.weblog.admin;



import com.hjx.weblog.client.ESclientUtil;
import com.hjx.weblog.common.file.FileCommon;
...
public class AdminUtil {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //3个副本，所以6个分片
        //AdminUtil.createIndices(client,"11111",3,1);
       AdminUtil.buildIndexAndTypes("chl_test8","chl_test8", "test/es/mapping/test.json",15,2);
        //index = 类型+日期
