 ...
 * 
 */
package com.hjx.weblog.hbase.extractor;
...
public class MapRowExtrator implements RowExtractor<Map<String,String>>,Serializable {
	...
	public Map<String, String> extractRowData(Result result, int rowNum)
		...
		for(Cell cell :  result.listCells()) {
			System.out.println("field==" + Bytes.toString(cell.getQualifierArray(), cell.getQualifierOffset(), cell.getQualifierLength()));
			System.out.println("field==" + Bytes.toString(cell.getValueArray(), cell.getValueOffset(), cell.getValueLength()));
