package com.hjx.weblog.common.db;
...
public class DBCommon {
    ...
    private static String MYSQL_PATH = EnvConstant.DEV + "/common/mysql.properties";
    ...
    public static void main(String[] args) {
        ...
        Connection tz_bigdata = DBCommon.getConn("log_warn");
